                        ...
                        {{-- <table  class="table table-bordered" style="font-size: 13px;">
                            ...
                            <tbody id="row_body">
                                <tr >
                                 ...
                                 <td style="max-width: 200px;">
                                     <input type="text" id="saman_bibaran"  >
                                 </td>

                                 <td style="max-width: 200px;">
                                     <input type="number" id="saman_pahichan_no"  >
                                 </td>

                                 <td>
                                         <input type="number" id="anumati_mamrmat_lagat"  >
                                 </td>
                                 <td>
                                     <input type="text"   class="form-control" value="" >
                                 </td> 
                                 <td>
                                     <input type="text"  value="{{$staff->nep_name}}" readonly>
                                 </td>

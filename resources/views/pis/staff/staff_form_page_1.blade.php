        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group col-md-4">
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">संस्था दर्ता नम्बर <i
                            class="reqq">*</i> </span></div>
                        <input type="number" id="nep_s_no" name="sanstha_darta_no"  class="form-control" value="{{isset($data->sanstha_darta_no) ? $data->sanstha_darta_no : ''}}" required>

                    </div>
                    @error('sanstha_darta_no')
                ...
                <div class="form-group col-md-4">
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text">प्याननम्बर <i
                            class="reqq">*</i> </span></div>
                            <input type="number" id="nep_s_no" name="pyan_no"  class="form-control" value="{{isset($data->sanstha_darta_no) ? $data->sanstha_darta_no : ''}}" required>
                        </div>
                        @error('pyan_no')
                            <strong>{{$message}}</strong>
                        @enderror
                ...
                <table class="table">
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">जन्म मिति विवरण : <i class="reqq">*</i></span></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">जारी जिल्ला<i class="reqq">*</i></span></div>
                                <select id="cs_district" name="cs_district" class="form-control select2" required>
                        ...
                        <td>
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">जारी मिति<i class="reqq">*</i></span></div>
                                <input type="text" id="cs_issue" name="cs_issue" class="form-control" value="{{isset($data->cs_issue)? $data->cs_issue: ''}}" required>
                                @error('cs_issue')
                                <strong> {{$message}} </strong>
                            @enderror
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">बाबुको नाम (नेपालीमा)<i class="reqq">*</i></span>
                                </div>
                                <input type="text" id="father_nep_name" name="father_nep_name" class="form-control"
                                    value="{{isset($data->father_nep_name)? $data->father_nep_name: ''}}" required>
                        ...
                        <td>
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">(अंग्रेजीमा)<i class="reqq">*</i></span></div>
                                <input type="text" id="father_name" name="father_name" class="form-control" value="{{isset($data->father_name)? $data->father_name: ''}}" required>
                            </div>
                        </td>
                        <td>
                            <div class="input-group col-md-12">
                    ...
                    <tr>
                        <td>
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">बाजेको नाम (नेपालीमा)<i class="reqq">*</i></span>
                                </div>
                                <input type="text" id="g_father_nep_name" name="g_father_nep_name" class="form-control"
                                    value="{{isset($data->g_father_nep_name)? $data->g_father_nep_name: ''}}" required>
                        ...
                        <td>
                            <div class="input-group col-md-12">
                                <div class="input-group-prepend"><span class="input-group-text">(अंग्रेजीमा)<i class="reqq">*</i></span></div>
                                <input type="text" id="g_father_name" name="g_father_name" class="form-control" value="{{isset($data->g_father_name)? $data->g_father_name: ''}}" required>
                                @error('g_father_name')
                                <strong> {{$message}} </strong>
                                 @enderror
                            </div>
            ...
            <a href="{{route('page_2_show')}}" class="btn btn-warning"><i class="fas fa-angle-double-right"></i> Next</a>
            </div>  
        </div>
    </form>
@endsection

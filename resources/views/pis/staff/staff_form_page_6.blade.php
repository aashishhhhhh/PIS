...
<div class="card-footer" style="text-align: center">
    <a  href="{{route('page_5_show')}}" class="btn btn-success"><i class="fas fa-angle-double-left"></i> Previous</a>
    <button type="submit" class="btn btn-primary">Save & Next</button>
    <a href="{{route('page_7_show')}}" class="btn btn-warning"><i class="fas fa-angle-double-right"></i> Next</a>
</div>
</div>

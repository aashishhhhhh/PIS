...
<div class="card px-4 py-4 mt-4">
    ...
    <section class="content-header">
        <h1 class="pull-left">एडिट माग फारम
        </h1>
    </section>
        ...
        @endif
            <div class="col-md-12" id="right-col">
                ...
                <div class="box box-primary">
                    <!-- /.box-header -->
                    <form action="{{route('update-maag-form')}}" method="POST">
                        @csrf
                    <div class="box-body">
                        ...
                        @endforeach
                                <tbody id="row_body">
                                       <tr id="rem_bank1">
                                        ...
                                        <td style="max-width: 200px;">
                                            <input type="text" id="specificationn" value="{{$value->specification}}"  name="specification[]" readonly>
                                        </td>

                                        <td>
                                                <input class="unit" id="unitt" value="{{$value->unit}}" name="unit[]" readonly>
                                        </td>
                                        <td>
                                            <input type="number" id="office_name_address" value="{{$value->quantity}}" name="quantity[]" class="form-control" value="" >
                                        </td> 
                                        <td>
                                            <input type="text" id="office_name_address" value="{{$value->remarks}}" name="remarks[]" class="form-control" value="" >
                                        </td>
                                        <td>
                    ...
                    <div class="col-md-4">
                        @if ($value->kharid_type==1)
                        <p> <input type="radio" class="radio" name="radio" value="1" checked> क.) बजारबाट खरिद गरि दिनु </p>
                        ...
                        <p> <input type="radio" class="radio" name="radio" value="2" checked>  ख.) मौज्दातबाट दिनु</p>
                        @endif
                    </div>

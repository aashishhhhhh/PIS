...
<div class="card px-4 py-4 mt-10" >
    ...
    <form method="POST" action="{{route('leave-application-submit')}}" enctype="multipart/form-data">
        @csrf
            @if (session()->has('msg'))
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" min="0" id="leave_left"   class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="to_date"  name="to_date" class="form-control to_date">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-8">
                        <div class="input-group">
                            ...
                            <textarea id="leave_reason" name="leave_reason" id="" cols="100" rows="10"></textarea>
                        </div>
                    </div>
                </div>
            </div> 

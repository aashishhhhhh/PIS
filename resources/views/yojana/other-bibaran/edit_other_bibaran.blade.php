                                        ...
                                        <div class="form-group mt-2">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $other_bibaran->formation_start_date }}" required>
                                        ...
                                        <div class="form-group mt-2">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="committee_count" value="{{ $other_bibaran->committee_count }}"
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                ...
                                                name="start_date" id="start_date" value="{{$other_bibaran->start_date}}" required>
                                            @error('start_date')
                                                <p class="invalid-feedback" style="font-size: 0.9rem">
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                ...
                                                name="end_date" id="end_date" value="{{$other_bibaran->end_date}}">
                                            @error('end_date')
                                                <p class="invalid-feedback" style="font-size: 0.9rem">
                                                ...
                                                <div class="form-group mt-2">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="date[]" value="{{$otherBibaranDetail->date}}">
                                                        @error('date')
                                                            <p class="invalid-feedback" style="font-size: 0.9rem">

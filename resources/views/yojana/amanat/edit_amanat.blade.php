            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST" action="{{ route('plan_amanat_marfat.update',$amanat) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                ...
                                                name="name" id="name" value="{{ $amanat->name }}" required>
                                            @error('name')
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                ...
                                                name="address" id="address" value="{{ $amanat->address }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 mt-2">
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="fullname"
                                                id="fullname" value="{{ $amanat->fullname }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 mt-2">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                value="{{ $amanat->issue_district }}" name="issue_district"
                                                id="issue_district">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 mt-2">
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                value="{{ $amanat->mobile_no }}" name="mobile_no" id="mobile_no">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">

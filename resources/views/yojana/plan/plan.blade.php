                            ...
                            <tbody>
                                @foreach ($plans as $key => $plan)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($plan->type_of_allocation_id == config('constant.wada_stariya_id'))
                                                @foreach ($plan->wardDetail as $ward)
                                                    @if ($ward->is_main)
                                                        {{ Nepali($ward->ward_no) }}
                                                    @endif
                                                @endforeach
                                    ...
                                    @foreach ($plan->parents as $keyChild => $parent)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($parent->type_of_allocation_id == config('constant.wada_stariya_id'))
                                                    @foreach ($plan->wardDetail as $ward)
                                                        @if ($ward->is_main)
                                                            {{ Nepali($ward->ward_no) }}
                                                        @endif

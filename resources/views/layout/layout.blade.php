...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <a href="https://sarathitechnosoft.com.np/">Sarathi technosoft</a>.</strong>
            All rights reserved.
        </footer>
    ...
    <script>
        ...
        $('.number').on('input', function() {
            this.value = convertToEnglishDigit(this.value);
        });

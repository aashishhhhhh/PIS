...
class NepaliCalender
{
    ...
    public function eng_to_nep($date)
    {
        ...
        if ($chk !== TRUE) {
            ...
            // this is modified by bidhan to get only accurate date
            $this->_nep_date = $y . '-' . ($m < 10 ? 0 . $m : $m) . '-' . $total_nDays;
    ...
    // this function is added by bidhan to directly convert date BS to AD
    public function BsToAd($date)
    {
        $year = Carbon::parse($date)->year;
        $month = Carbon::parse($date)->month;
        $day = Carbon::parse($date)->day;
        return $this->nep_to_eng($year, $month, $day);
    }
    ...
    public function AdToBs($date)
    {
        ...
        $month = Carbon::parse($date)->month;
        $day = Carbon::parse($date)->day;
        return $this->eng_to_nep($year, $month, $day);
    }
    ...
    public function nep_to_eng($yy, $mm, $dd)
    {
        ...
        if ($chk !== TRUE) {
            ...
            // this is modified by bidhan to get only accurate date
            $this->_eng_date = $y . '-' . ($m < 10 ? 0 . $m : $m) . '-' . $total_eDays;
